      ...
      <div className="flex justify-between items-center pb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium transition duration-200 flex items-center gap-2"
          >
            <LogOutIcon /> Sair
          </button>
        </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-4 space-y-4">
            {/* Botão de Baixar Recibo - ADICIONADO */}
      ...
      {showConfirmLogout && (
        <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full">
            ...
            <div className="p-4">
              <p className="text-gray-600 mb-4">Tem certeza que deseja sair do sistema?</p>
              ...
              <div className="flex gap-3">
                ...
                <button 
                  onClick={onLogout}
                  className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-lg font-medium transition duration-200 flex items-center justify-center gap-2"
                >
                  <LogOutIcon /> Sim, Sair
                </button>
              </div>
...
export default CaixaPrincipalScreen;